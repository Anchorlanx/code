...
function library:add_corner(obj, radius)
    ...
    function menu.new_tab(tab_image)
        ...
        function tab.new_section(section_name)
            ...
            function section.new_sector(sector_name, sector_side)
                ...
                library:add_corner(Container, 6)
                ...
                function sector.element(type, text, data, callback, c_flag)
                    ...
                    if type == "Toggle" then
                        ...
                        library:add_corner(ToggleFrame, 4)
                        ...
                        function element:add_keybind(key_default, key_callback)
                            ...
                            library:add_corner(KeybindFrame, 6)
                        ...
                        function element:add_color(color_default, has_transparency, color_callback)
                            ...
                            library:add_corner(ColorButton, 4)
                            ...
                            library:add_corner(ColorFrame, 6)
                            ...
                            library:add_corner(ColorPicker, 4)
                            ...
                            library:add_corner(HuePicker, 4)
                            ...
                            if has_transparency then
                                ...
                                library:add_corner(TransparencyPicker, 4)
                    ...
                    elseif type == "Dropdown" then
                        ...
                        library:add_corner(DropdownButton, 4)
                        ...
                        library:add_corner(DropdownScroll, 4)
                    ...
                    elseif type == "Scroll" then
                        ...
                        library:add_corner(ScrollFrame, 4)
                    ...
                    elseif type == "Slider" then
                        ...
                        library:add_corner(SliderButton, 5)
                        ...
                        library:add_corner(SliderFrame, 5)
